...
const Page: React.FC<ContainerProps> = ({}) => {
    ...
    const contentStyle: React.CSSProperties = {
        ...
        alignItems: 'center',
        height: '100vh',
        backgroundColor: '#4CAF50', // 이미지에 표시된 배경색으로 가정
        color: 'white',
        textAlign: 'center',
        fontSize: '1.2em', // 가정된 폰트 크기
        padding: '20px',
    };

    const headerStyle: React.CSSProperties = {
        fontSize: '2em', // 가정된 헤더 폰트 크기
        fontWeight: 'bold',
        marginBottom: '0.5em',
    };
    ...
    // 버튼 스타일은 이미 commonSlideElementStyle에 정의되어 있으므로 추가하지 않음

    // 이미지 스타일 (SlideImage 내부에 이미지 스타일을 적용하는 것으로 가정)
    const imageStyle: React.CSSProperties = {
        width: '200px', // 이미지 크기 조정
        height: 'auto',
        margin: '2em 0', // 이미지와 텍스트 사이 간격 조정
    };
    ...
    return (<IonPage>
        <IonContent fullscreen style={{
            ...
            backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIev0jx1HSLfd-RbpG0S3lKYDRG4w-sKsurw&usqp=CAU')",
    ...
    backgroundRepeat: "no-repeat"
            ...
            <Swiper
                ...
                // 명륜이 <SlideImage src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRK55Rxdrg6kRg7vAonFRCZtg7iSs78AYgYPdk9K6JgmQ&s"} />
            >
                <SwiperSlide>
                    <section>
                        <h1>Welcome!</h1>
